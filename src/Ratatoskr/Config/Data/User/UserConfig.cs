...
namespace Ratatoskr.Config.Data.User
{
    ...
    [Serializable]
    internal sealed class UserConfig : ConfigRoot<UserConfig>
    {
        ...
        public EnumConfig<SendPanelType> SendPanelType       { get; } = new EnumConfig<SendPanelType>(User.SendPanelType.Data);
        ...
        public EnumConfig<SendDataListMode> SendDataListMode   { get; } = new EnumConfig<SendDataListMode>(User.SendDataListMode.Details);
