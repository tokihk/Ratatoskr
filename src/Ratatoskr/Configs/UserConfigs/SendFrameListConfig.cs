...
{
    [Serializable]
    internal sealed class SendFrameConfig
    {
    ...
    [Serializable]
    internal sealed class SendFrameListConfig : ConfigObject, IConfigDataReadOnly<List<SendFrameConfig>>, IConfigReader, IConfigWriter
    {
