...
{
    [Serializable]
    internal sealed class PacketConverterObjectConfig
    {
    ...
    internal sealed class PacketConverterConfig : ConfigObject, IConfigDataReadOnly<List<PacketConverterObjectConfig>>, IConfigReader, IConfigWriter
    {
        ...
        {
            Value.Add(new PacketConverterObjectConfig(PacketConverters.Filter.PacketConverterClassImpl.ClassID, null));
        }
