...
namespace Ratatoskr.Configs.Types
{
    ...
    [Serializable]
    internal sealed class KeyActionConfig<EnumT>
        where EnumT : struct
    {
    ...
    [Serializable]
    internal sealed class KeyConfig<EnumT> : ConfigObject, IConfigDataReadOnly<List<KeyActionConfig<EnumT>>>, IConfigReader, IConfigWriter
        where EnumT : struct
    {
