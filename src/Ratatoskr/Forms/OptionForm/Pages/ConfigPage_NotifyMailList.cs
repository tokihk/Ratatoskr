...
{
    internal partial class ConfigPage_NotifyMailList : OptionFormPage
    {
        ...
        public ConfigPage_NotifyMailList()
        {
            InitializeComponent();
        }
        ...
        protected override void OnLoadConfig()
        {
            LBox_SettingList.BeginUpdate();
            {
                ...
                foreach (var config in Config.NotifyMailList.Value) {
        ...
        {
            Config.NotifyMailList.Value.Clear();

            foreach (SettingItem item in LBox_SettingList.Items) {
                Config.NotifyMailList.Value.Add(item.Config);
            }
        }
        ...
        {
            /* 新規設定作成 */
            var config = new NotifyMailConfig();
