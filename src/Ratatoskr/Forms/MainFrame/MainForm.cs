    ...
    internal partial class MainForm : Form
    {
        ...
        private void InitializeMenuBar()
        {
            void InitializeMenuBarItem(ToolStripMenuItem menu)
            {
                ...
                if (menu.Tag is string) {
                    ...
                    if (FormKeyManager.ActionIdTextToValue(menu.Tag as string, ref id)) {
                        menu.Tag = id;
                    }
        ...
        private void LoadMenuBarShortcutConfig()
        {
            void LoadMenuBarShortcutConfig(ToolStripMenuItem menu)
            {
                ...
                } else if (menu.Tag is MainFormActionId) {
                    /* 機能が割り当てられたメニュー */
                    menu.ShortcutKeyDisplayString = FormKeyManager.MainFormShortcutKeyText((MainFormActionId)menu.Tag);
                }
            }
        ...
        public void UpdateMenuBar()
        {
            ...
            MenuBar_Tool_ScriptManager.Checked = FormUiManager.ScriptIDEVisible();
        }
        ...
        private void OnMenuBarClick(object sender, EventArgs e)
        {
            ...
            if (menu == null)return;
            if (!(menu.Tag is MainFormActionId))return;

            FormKeyManager.MainFormKeyAction(this, (MainFormActionId)menu.Tag);
        }
        ...
        private void MainFrame_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            FormKeyManager.MainFormKeyAction(this, config.ActionID);
        }
        ...
        {
            FormUiManager.ScriptIDEVisible(!FormUiManager.ScriptIDEVisible());
            UpdateMenuBar();
        }
