...
{
    internal partial class MainForm_PacketConverter : UserControl
    {
        private bool init_complete_ = false;


        public MainForm_PacketConverter()
        {
            InitializeComponent();
        }

        public MainForm_PacketConverter(PacketConverterInstance pcvti) : this()
        {
            Instance = pcvti;
        ...
        {
            var panel = Parent as MainForm_PacketConverterPanel;
