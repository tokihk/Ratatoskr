...
{
    internal partial class MainForm_PacketConverterPanel : FlowLayoutPanel
    {

        public MainForm_PacketConverterPanel() : base()
        {
            InitializeComponent();
        }
        ...
        public void ClearPacketConverter()
        {
            while (Controls.Count > 0) {
                RemovePacketConverter(Controls[0] as MainForm_PacketConverter);
            }
        }
        ...
        public void AddPacketConverter(Guid class_id, PacketConverterProperty pcvtp)
        {
            ...
            var control = new MainForm_PacketConverter(pcvti);

            Controls.Add(control);
        }

        public void RemovePacketConverter(MainForm_PacketConverter control)
        {
        ...
        public void MoveConverterIndex(MainForm_PacketConverter control, Point pos_screen)
        {
        ...
        {
            foreach (MainForm_PacketConverter control in Controls) {
