...
{
    internal class MainForm_SendPanel : UserControl
    {
        public MainForm_SendPanel()
        {
        }

        public MainForm_SendPanel(MainForm_SendPanelContainer panel) : this()
        {
            ControlPanel = panel;
        }

        protected MainForm_SendPanelContainer ControlPanel { get; }
