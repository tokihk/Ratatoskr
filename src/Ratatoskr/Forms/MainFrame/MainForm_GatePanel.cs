...
{
    internal partial class MainForm_GatePanel : UserControl
    {
        private List<MainForm_Gate> gatec_list_ = new List<MainForm_Gate>();


        public MainForm_GatePanel()
        {
            InitializeComponent();
        }
        ...
        public void AddGate(GateProperty gatep, DeviceConfig devconf, Guid devc_id, DeviceProperty devp)
        {
            ...
            var gatec = new MainForm_Gate(gate);
