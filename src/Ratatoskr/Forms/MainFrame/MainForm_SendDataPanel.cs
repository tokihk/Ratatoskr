...
{
    internal partial class MainForm_SendDataPanel : MainForm_SendPanel
    {
        ...
        public MainForm_SendDataPanel() : base(null)
        {
            InitializeComponent();
        }

        public MainForm_SendDataPanel(MainForm_SendPanelContainer panel) : base(panel)
        {
            InitializeComponent();
...
//            CBox_ExpList.Enabled = false;
            ...
            /* 送信実行 */
            API_Send.Exec(target, send_data_exp_);
