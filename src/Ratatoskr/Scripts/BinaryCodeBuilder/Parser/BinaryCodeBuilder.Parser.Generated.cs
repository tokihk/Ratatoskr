...
// UserName: i32719
// Input file <Scripts\BinaryCodeBuilder\Parser\BinaryCodeBuilder.Language.grammar.y - 2018/10/23 11:44:15>
...
[GeneratedCodeAttribute( "Gardens Point Parser Generator", "1.5.2")]
internal class BinaryCodeBuilderParser: ShiftReduceParser<ValueType, LexLocation>
{
  // Verbatim content from Scripts\BinaryCodeBuilder\Parser\BinaryCodeBuilder.Language.grammar.y - 2018/10/23 11:44:15
	private BinaryCode        parse_data_;
	private Encoding          parse_encoder_;
	private List<BinaryCode>  value_bin_list_;
  // End verbatim content from Scripts\BinaryCodeBuilder\Parser\BinaryCodeBuilder.Language.grammar.y - 2018/10/23 11:44:15
...
#pragma warning restore 649
  ...
  static BinaryCodeBuilderParser() {
...
{
		CurrentSemanticValue.value_bin = new BinaryCode(parse_encoder_, ValueStack[ValueStack.Depth-1].value_str);
	}
        break;
...
{
		CurrentSemanticValue.value_bin = MacroProcessor.Run(ValueStack[ValueStack.Depth-2].value_str, value_bin_list_);
	}
        break;
      case 12: // term_macro -> DOLLAR, LP, MACRO_NAME, expression_list, RP
{
		CurrentSemanticValue.value_bin = MacroProcessor.Run(ValueStack[ValueStack.Depth-3].value_str, value_bin_list_);
	}
        break;
    }
