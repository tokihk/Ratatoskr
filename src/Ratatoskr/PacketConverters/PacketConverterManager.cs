...
{
    internal sealed class PacketConverterManager
    {
        ...
        public delegate void ConvertRuleUpdatedDelegate();

        public event ConvertRuleUpdatedDelegate ConvertStatusUpdated   = delegate() { };
        ...
        public PacketConverterManager()
        {
        }

        public IEnumerable<PacketConverterClass> GetClasses()
        {
            lock (pcvtd_list_) {
        ...
        public IEnumerable<PacketConverterInstance> GetInstances()
        {
