...
{
    internal partial class PacketConverterInstance : UserControl
    {
        private PacketConverterManager pcvtm_;
        ...
        public PacketConverterInstance(PacketConverterManager pcvtm, PacketConverterClass pcvtd, PacketConverterProperty pcvtp, Guid id)
        {
            InitializeComponent();
