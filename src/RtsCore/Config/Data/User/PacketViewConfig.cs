...
{
    [Serializable]
    public sealed class PacketViewObjectConfig
    {
    ...
    [Serializable]
    public sealed class PacketViewConfig : ConfigObject, IConfigDataReadOnly<List<PacketViewObjectConfig>>, IConfigReader, IConfigWriter
    {
