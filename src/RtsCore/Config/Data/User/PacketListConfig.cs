...
{
    [Serializable]
    public sealed class PacketObjectConfig
    {
    ...
    [Serializable]
    public sealed class PacketListConfig : ConfigObject, IConfigDataReadOnly<List<PacketObjectConfig>>, IConfigReader, IConfigWriter
    {
