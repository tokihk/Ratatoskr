...
using RtsCore.Framework.Gate;

namespace RtsCore.Framework.Config.Data.User
{
    [Serializable]
    public sealed class GateObjectConfig
    {
    ...
    [Serializable]
    public sealed class GateListConfig : ConfigObject, IConfigDataReadOnly<List<GateObjectConfig>>, IConfigReader, IConfigWriter
    {
