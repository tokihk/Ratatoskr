...
namespace RtsCore.Protocol
{
    ...
    public class ProtocolDecodeData2
    {
        public ProtocolDecodeData2(DateTime decode_time, uint channel, DateTime block_time, uint block_index, string message, ProtocolFrameElement data, DecodeDataStatus status)
        {
