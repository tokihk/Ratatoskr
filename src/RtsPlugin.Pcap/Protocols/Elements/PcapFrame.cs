...
namespace RtsPlugin.Pcap.Protocols.Elements
{
    public class PcapParser
    {
        public static ProtocolFrameElement ParsePacket(ProtocolFrameElement parent, PacketDotNet.Packet packet)
        {
            ...
            if (elem == null) {
                var packet_bitlen = (uint)packet.HeaderData.Length * 8;

                elem = new ProtocolFrameElement_BitData(parent, "Payload Data", packet_bitlen, new BitData(packet.Bytes, packet_bitlen));
            }
